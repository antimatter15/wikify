...
i.setAttribute("style",'width: 280px; height: 25px; position: absolute; top: 0; left: 0; background-color: #0099FF');

i.innerHTML = '<span style="color:#FFFF00">&nbsp;Wikify&nbsp;-&nbsp;</span><span id="Wikify_Status" style="color:#66FF00">Loaded</span><span style="right:3px;position:absolute">'+links+'</span>'
